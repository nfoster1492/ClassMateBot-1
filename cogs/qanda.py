...
class Qanda(commands.Cog):
    ...
    async def askQuestion(self, ctx, 
                          ...
                          anonymous: str = commands.parameter(description="Option if the user wants to be anonymous or not", default="")
                        ):
    ...
    async def answer(self, ctx,
                     ...
                     anonymous: str = commands.parameter(description="Option if the user wants their question to be shown anonymously", default="")
                    ):
    ...
    async def deleteAllAnsFor(self, ctx, 
    ...
    async def getAllAnsFor(self, ctx, 
                           num: str = commands.parameter(description="Question number")
                        ):
    ...
    async def deleteOneQuestion(self, ctx, 
    ...
    async def channelOneGhost(self, ctx, 
                              num: str = commands.parameter(description="Question number")):
    ...
    async def restoreGhost(self, ctx, 
                           num: str = commands.parameter(description="Question number that you want to restore")
                        ):
